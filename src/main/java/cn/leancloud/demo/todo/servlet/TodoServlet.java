package cn.leancloud.demo.todo.servlet;
...
public class TodoServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            AVQuery<TodoBean> query = AVObject.getQuery(TodoBean.class);
            ...
            if (e.getCode() == AVException.OBJECT_NOT_FOUND) {
                // 该错误的信息为：{ code: 101, message: 'Class or object doesn\'t exists.' }，说明 TodoBean
                // 数据表还未创建，所以返回空的
